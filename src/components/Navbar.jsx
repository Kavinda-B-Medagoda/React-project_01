  ...
  return (
    <div className='max-w-[1640] mx-auto flex justify-between items-center p-4'>
      ...
      <div className='flex items-center'>
        ...
        <h1 className='text-2xl sm:text-3xl lg:text-4xl px-2 flex items-center'>Best <span className='font-bold'>Eats</span></h1>
      ...
      {/* cart button */}
      <button className=' items-center bg-black text-white hidden md:flex py-2 rounded-full'>
